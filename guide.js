...
const tutorActionsController = require('./controllers/tutorActions');
...
function initializeRoutes() {
  ...
  router.get('/student/:studentId/tutor-actions', authz.middleware(1), tutorActionsController.index);
